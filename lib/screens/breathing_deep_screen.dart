// lib/screens/breathing_deep_screen.dart
...
class BreathingDeepScreen extends StatefulWidget {
  const BreathingDeepScreen({super.key});

  @override
  State<BreathingDeepScreen> createState() => _BreathingDeepScreenState();
}

class _BreathingDeepScreenState extends State<BreathingDeepScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _recordBreathingExercise() async {
    ...
    try {
      await FirebaseFirestore.instance
          ...
          .add({
        'exercise_type': 'Derin Nefes Egzersizi',
        'tarih': Timestamp.now(),
      });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Derin Nefes Egzersizi'),
